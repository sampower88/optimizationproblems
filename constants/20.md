...
$C_{20}$ is the **Crouzeix constant** (sometimes denoted $Q$).  It is the smallest constant $C$ such that for every $n \ge 1$, every complex matrix $A \in \mathbb{C}^{n \times n}$, and every complex polynomial $p$ one has
$$
...
- Crouzeix conjectured (in [C2004]) that $C_{20}=2$.  The lower bound $2$ shows this would be sharp.
