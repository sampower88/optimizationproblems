...
| ----- | --------- | -------- |
| $\infty$ | Trivial | No finite uniform upper bound is known (i.e. it is open whether $(B_{\mathbb R,m})_{m\ge 1}$ is bounded). The best known general estimates for each fixed $m$ are sublinear in $m$; for example $B_{\mathbb R,m} < 1.3\ m^{0.365}$ for $m\ge 14$ [CP2018]. |
